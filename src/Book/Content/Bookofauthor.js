...
const Authorspecific = () => {
   ...
   const {Roy,commonvault,updCommonvault,updrangeList} = useContext(Appcontext); 
...
//*********************************************Common storage render*******************************
    ...
    return(
        <div className="new_right" >
            <div className='author_alone' key={Roy[0].id}>                
                <div><img src={Roy[0].authorimg} alt={Roy[0].author}/></div>
                <div>
                    <h3>{Roy[0].author}</h3>
                    <p className='author_featured_detail'>{Roy[0].aboutAuthor}</p>
