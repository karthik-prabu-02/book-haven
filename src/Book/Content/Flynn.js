...
const FLYNN = () => {
   ...
   const {Flyn,commonvault,updCommonvault,updrangeList} = useContext(Appcontext); 
   console.log(Flyn,'flyn');
...
//*********************************************Common storage render*******************************
    ...
    return(
        <div className="new_right" >
            <div className='author_alone' key={Flyn[0].id}>                
                <div><img src={Flyn[0].authorimg} alt={Flyn[0].author}/></div>
                <div>
                    <h3>{Flyn[0].author}</h3>
                    <p className='author_featured_detail'>{Flyn[0].aboutAuthor}</p>
