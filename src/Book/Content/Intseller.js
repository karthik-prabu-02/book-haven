...
const Intseller = () => {
   ...
   const {Intbstsellers,commonvault,updCommonvault,updrangeList} = useContext(Appcontext);
   ...
   //*********************************************Common storage*******************************
       ...
       useEffect(()=>{
               updCommonvault(Intbstsellers);   
               updrangeList(Intbstsellers);     
       ...
       return(
           <>
               <div className="new_right" >
                   <h1 className="Title_Book_h1">International Best sellers</h1>
