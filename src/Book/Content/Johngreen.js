...
const Jgreen = () => {
   ...
   const {Green,commonvault,updCommonvault,updrangeList} = useContext(Appcontext); 
 
 //*********************************************Common storage*******************************
    
    useEffect(()=>{
        updCommonvault(Green);   
        updrangeList(Green);     
...
//*********************************************Common storage render*******************************
    ...
    return(
        <div className="new_right" >
            <div className='author_alone' key={Green[0].id}>                
                <div><img src={Green[0].authorimg} alt={Green[0].author}/></div>
                <div>
                    <h3>{Green[0].author}</h3>
                    <p className='author_featured_detail'>{Green[0].aboutAuthor}</p>
