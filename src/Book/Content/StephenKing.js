...
const StephenKing = () => {
   ...
   const {King,commonvault,updCommonvault,updrangeList} = useContext(Appcontext); 
...
//*********************************************Common storage render*******************************
    ...
    return(
        <div className="new_right" >
            <div className='author_alone' key={King[0].id}>                
                <div><img src={King[0].authorimg} alt={King[0].author}/></div>
                <div>
                    <h3>{King[0].author}</h3>
                    <p className='author_featured_detail'>{King[0].aboutAuthor}</p>
