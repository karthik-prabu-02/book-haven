...
const Forman = () => {
   ...
   const {Forman,commonvault,updCommonvault,updrangeList} = useContext(Appcontext); 
 
 //*********************************************Common storage*******************************
    
    useEffect(()=>{
        updCommonvault(Forman);   
        updrangeList(Forman);     
...
//*********************************************Common storage render*******************************
    ...
    return(
        <div className="new_right" >
            <div className='author_alone' key={Forman[0].id}>                
                <div><img src={Forman[0].authorimg} alt={Forman[0].author}/></div>
                <div>
                    <h3>{Forman[0].author}</h3>
                    <p className='author_featured_detail'>{Forman[0].aboutAuthor}</p>
