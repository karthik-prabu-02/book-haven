...
//*********************************************New Arrival data*******************************    
   ...
   const {BestSellers,commonvault,updCommonvault,updrangeList} = useContext(Appcontext);
...
//*********************************************Common storage*******************************
    ...
    useEffect(()=>{
            updCommonvault(BestSellers);   
            updrangeList(BestSellers);     
    ...
    return(
        <>
            <div className="new_right" >
                <h1 className="Title_Book_h1">Book Store</h1>
