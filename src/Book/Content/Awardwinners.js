...
const Awardwinner = () => {
//*********************************************New Arrival data*******************************    
    const {Awardwinners,commonvault,updCommonvault,updrangeList}=useContext(Appcontext);
...
//*********************************************Common storage*******************************
    ...
    useEffect(()=>{
            updCommonvault(Awardwinners);   
            updrangeList(Awardwinners);     
...
//*********************************************Common storage render*******************************
    ...
    return(
        <>
            ...
            <h1 className="Title_Book_h1">Award Winners</h1>
