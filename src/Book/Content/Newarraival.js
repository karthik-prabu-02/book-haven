...
//*********************************************New Arrival data*******************************    
    ...
    const {NewArrival,commonvault,updCommonvault,updrangeList} = useContext(Appcontext);
...
//*********************************************Common storage*******************************    
    useEffect(()=>{
            updCommonvault(NewArrival);      
            updrangeList(NewArrival); 
        //below line is to avoid warning msg about dependencies ---because dependencies causes infinite loop 
        // eslint-disable-next-line react-hooks/exhaustive-deps
    },[])
    // console.log(commonvault,"common_arr");
    // console.log(NewArrival,"arr");
...
//*********************************************Common storage render*******************************
    ...
    return(
        <>
            ...
            <h1 className="Title_Book_h1">New Arrivals</h1>
